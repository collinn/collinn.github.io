...
When you Knit an R Markdown file, it will ask you to first save and name your document. I recommend sticking to a consistent format throughout the semester: something like `lastname_firstname_[lab/hwk]#.Rmd`. For example, I would name this `nolte_collin_lab1.Rmd`. After you knit, this will also be the name of your pdf.
