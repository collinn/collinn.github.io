...
**Question #11 (Part 1):** Look at the documentation for the `boxplot` function (`?boxplot`) and determine which argument makes the box plot horizontal. Plot a horizontal box plot for the regions in the Happy Planet data.
