...
also discuss code chunk options and opts_chunk in the setup block
...
The aesthetics of a `ggplot2` plot (which I will hereby simply call a "ggplot") establish the most general properties relating our collected data to the visual representation we wish to create. 

specifically, they create a map *from the variables in the data* to visual properties of the graph

Suppose for example we wish to consider the relationship between engine displacement and highway fuel economy in the `mpg` dataset. The first order of business would be to establish these variables as the x and y axes.
...
**Question X** Identify the three components that were needed to produce the scatter plot above, namely the data, the aesthetics, and the layers.
...
maybe could say something about individual (plots) vs collective (color) geoms
