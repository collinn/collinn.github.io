...
- Modeling a numeric outcome
    - Lab XX (modeling a numeric outcome), Lab XX (cross-validation)
- Modeling a categorical outcome
    - Lab XX (modeling a categorical outcome), Lab XX (decision tree models)
...
2. R Shiny Presentations (midterm 2)
    ...
    - [ZOOM LINK](https://uiowa.zoom.us/j/94921676456?pwd=Qld4MjBwSzZNWkxNTWJ1VFlXQ3Y5Zz09)
